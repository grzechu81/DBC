...
#define PIN_RW PERIPHS_IO_MUX_GPIO4_U //FUNC_GPIO4, D4
#define PIN_RW_N 4
#define PIN_RW_MASK 0x8

#define DATA_PINS_MASK    0xf000
#define CONTROL_PINS_MASK 0x15

#define RS_HIGH GPIO_REG_WRITE(GPIO_OUT_W1TS_ADDRESS, PIN_RS_MASK)
#define RS_LOW  GPIO_REG_WRITE(GPIO_OUT_W1TC_ADDRESS, PIN_RS_MASK)
#define RW_HIGH GPIO_REG_WRITE(GPIO_OUT_W1TS_ADDRESS, PIN_RW_MASK)
#define RW_LOW  GPIO_REG_WRITE(GPIO_OUT_W1TC_ADDRESS, PIN_RW_MASK)
#define E_HIGH GPIO_REG_WRITE(GPIO_OUT_W1TS_ADDRESS, PIN_E_MASK)
#define E_LOW  GPIO_REG_WRITE(GPIO_OUT_W1TC_ADDRESS, PIN_E_MASK)
